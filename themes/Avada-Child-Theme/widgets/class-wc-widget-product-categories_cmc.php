 ...
 * @extends WC_Widget
 */
class WC_Widget_Product_Categories_CMC extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_id          = 'woocommerce_product_categories_cmc';
		$this->widget_name        = __( 'CMC: Product Categories', 'woocommerce' );
		$this->settings           = array(
			'title'              => array(
				'type'  => 'text',
		...
		if ( $dropdown ) {
			...
			wc_enqueue_js(
				...
				jQuery( '.dropdown_product_cat' ).change( function() {
					var input = '<input type=\"hidden\" name=\"product_cat\" value=\"'+jQuery(this).val()+'\">';
