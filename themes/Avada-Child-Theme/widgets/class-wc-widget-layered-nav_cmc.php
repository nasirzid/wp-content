 ...
 */
class WC_Widget_Layered_Nav_CMC extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'CMC: Display a list of attributes to filter products in your store.', 'woocommerce' );
		$this->widget_id          = 'woocommerce_layered_nav_cmc';
		$this->widget_name        = __( 'CMS: Filter Products by Attribute', 'woocommerce' );
		parent::__construct();
	}
		...
		if ( $taxonomy !== $this->get_current_taxonomy() ) {
			...
			wc_enqueue_js(
				...
				jQuery( '.dropdown_layered_nav_" . esc_js( $taxonomy_filter_name ) . "' ).change( function() {
					...
					var input = '<input type=\"hidden\" name=\"filter_" . esc_js( $taxonomy_filter_name ) . "\" value=\"'+slug+'\">';
					jQuery('.cmc_product_search_form').append(input);
				});
