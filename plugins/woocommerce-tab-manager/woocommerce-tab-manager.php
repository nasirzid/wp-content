 ...
 *
 * Copyright: (c) 2012-2018, SkyVerge, Inc.
 *
...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.9.0', __( 'WooCommerce Tab Manager', 'woocommerce-tab-manager' ), __FILE__, 'init_woocommerce_tab_manager', array(
...
class WC_Tab_Manager extends SV_WC_Plugin {
	...
	public function add_plugin_action_links( $actions ) {
		...
		$custom_actions = array(
			'configure' => sprintf( '<a href="%1$s">%2$s</a>', admin_url( 'edit.php?post_type=wc_product_tab' ), __( 'Configure', 'woocommerce-tab-manager' ) ),
			'docs'      => sprintf( '<a href="%1$s">%2$s</a>', 'http://docs.woocommerce.com/document/tab-manager/', __( 'Docs', 'woocommerce-tab-manager' ) ),
			'support'   => sprintf( '<a href="%1$s">%2$s</a>', 'http://support.woocommerce.com/', __( 'Support', 'woocommerce-tab-manager' ) ),
			'review'    => sprintf( '<a href="%1$s">%2$s</a>', $this->get_review_url(), __( 'Write a Review', 'woocommerce-tab-manager' ) ),
		);
