=== WooPrice Calculator ===
Contributors: Altos Web Solutions Srls
...
For those who need more, WooPrice Calculator can go PRO (https://altoswebsolutions.com/cms-plugins/woopricecalculator) and add a series of functions and tools that were developed to simplify your job and improve the customers' experience:
...
Features: https://altoswebsolutions.com/cms-plugins/woopricecalculator
Documentation: https://altoswebsolutions.com/documentation/start
Forum: https://altoswebsolutions.com/forum/index
...
WPC PRO: https://altoswebsolutions.com/cms-plugins/woopricecalculator
...
Read download descriptions here: https://altoswebsolutions.com/download-free/category/7-wooprice-calculator-pro-for-wordpress
...
2. Create the calculator and set the expression to define the price of the product. Example: (($aws_price_calc_1*0.5)+($aws_price_calc_2*0.8))/2
