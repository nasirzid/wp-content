...
//				echo '$i='.$i.'<br />';
	...
	public static function INDEX($arrayValues,$rowNum = 0,$columnNum = 0) {
		...
		while(is_array($columnNum)) {
		    $columnNum = current($columnNum);
		}
...
/**
    ...
    */
	...
	/* Match esatto del valore ricercato */
        $rowNumber = $rowValue = False;
        ...
        if (!$not_exact_match) {
            ...
            /* Se non ho trovato un match esatto, passo ad effettuare un match approssimativo */
            $rowNumber = $rowValue = False;
            foreach($lookup_array[$firstColumn] as $rowKey => $rowData) {
